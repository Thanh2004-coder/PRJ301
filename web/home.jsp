        ...
        <div class="hero_area">
            ...
            <section class="slider_section ">
                <div class="slider_bg_box">
                    <img src="video/y2mate.com - GE76GE66 Raider10UX  World 1st Gaming Laptop Equips with WiFi 6E  MSI_1080p.mp4" alt="">
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title show_txt">
                                <a href="detail?pid=${product.id}" title="View Product">${product.name}</a>
                            </h4>
                            <div class="row">
                                <div class="col">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-6 px-0">
                        <div class="map_container">
                            <div class="map">
                                <img src="image/RAINY75.png" alt="Map" style="width: 100%; height: auto;" />
                            </div>
                        </div>
                    </div>
                </div>
